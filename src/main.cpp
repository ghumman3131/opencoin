...
uint256 hashGenesisBlock("0xe2baee2a1b6d11f2067ba3b89b8c379a9cf78d1c0bba2290a2e2bdb212ed86e0");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 10000); // Xxxcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Xxxcoin: 3.5 days
static const int64 nTargetSpacing = 5 * 60; // Xxxcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x57bcdb42092c345e5c63b18043d04ee4b7d52b4ff7a245922960d748ac4b7a7f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "New year eve 2017";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040bc193c10a994f3077349f895c3089b3ff119e2531faebf487c73075679157759adfecd68632f8493cf355c0c6379cbcc06050ae7771772c9fb06d6f1bef42e1") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1514745418;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084808716;

        if (fTestNet)
        {
            block.nTime    = 1514745391;
            block.nNonce   = 386195985;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x0b807f6c7544bf7d4a4dced8d553c4252cfc7e54cf08076fdd754037f47eb762"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc4, 0xb9, 0xde }; // Xxxcoin: increase each by adding 2 to bitcoin's value.
